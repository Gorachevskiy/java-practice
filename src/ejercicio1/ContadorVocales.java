...
public class ContadorVocales {
    ...
    public static void main(String[] args) {
        /* Recibo mediante argumntos lo que le usuario ha introducido en el proceso principal */
        /* y la vocal que habrá que contar. */
        ...
        for(int i=0; i<frase.length();i++) {
            /* Si el caracter en la posicion i coincide con la vocal sumo 1 al contador */
            if(frase.charAt(i)==vocal) {
                contador++;
            }
        }
        System.out.println("La frase: '" + frase + "' contiene " + contador + " " + vocal);
    }
}
